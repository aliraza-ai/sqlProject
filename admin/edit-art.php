    ...
    <body>
        ...
        <div id="wrapper">
            ...
            if (isset($_POST['add']))
            {
                ...
                $quiz=$_POST['quiz'];
                $check=$m->updateArt($cat,$title,$article,$example_detail,$example_code,$quiz,$id);
            ...
            $art=$m->getArticleById($id);
            $arts=$art->fetch_assoc();
                         ...
                         <div class="card-box">
                             ...
                             <form role="form" class="col-lg-7" method="post" action="">
                                 ...
                                 <div class="form-group">
                                     <label>Title:</label>
                                     <input class="form-control" value="<?php echo $arts['title']; ?>" required type="text" name="title"   placeholder="Enter Title" />
                                 </div>
                                 <div class="form-group">
                                     ...
                                     <select name="cats" class="form-control" required>
                                         ...
                                         <?php
                                         $getC=$m->getCatsById($arts['cat']);
                                         if($getC)
                                         {
                                             $getsC=$getC->fetch_assoc()
                                                 ...
                                                 <option value="<?php echo $getsC['id']; ?>"><?php echo $getsC['title']; ?></option>
                                                 <?php
                                 ...
                                 <div class="form-group">
                                     ...
                                     <textarea rows="20" name="article" required>
                                        <?php echo $arts['article_detail']; ?>
                                     </textarea>
                                 </div>
                                 <div class="form-group">
                                     <label>Example Detail</label>
                                     <textarea name="example_detail">
                                        <?php echo $arts['example_details']; ?>
                                     </textarea>
                                 </div>
                                 <div class="form-group">
                                 ...
                                 <div class="form-group">
                                     <label>Quiz</label>
                                     <input class="form-control" value=" <?php echo $arts['quiz']; ?>"   type="url" name="quiz"   placeholder="Quiz URL" />
                                 </div>
                                 <button type="submit" onclick="myfrom();" name="add" class="btn btn-primary"><i class="fa fa-sign-out fa-fw"></i> Update Article</button>
